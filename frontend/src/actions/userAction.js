...
export const updateProfile = (userData,token) => async (dispatch) => {
    try {
        ...
        const { data } = await axios.put(`/api/v1/profile/update/${token}`, userData, config)
...
export const loadUser = (token) => async (dispatch) => {
    try {
        ...
        const { data } = await axios.get(`/api/v1/user/${token}`)
...
export const updatePassword = (passwords,token) => async (dispatch) => {
    try {
        ...
        const { data } = await axios.put(`/api/v1/password/update/${token}`, passwords, config)
        ...
        toast.error("invalid old password try again")          
...
export const resetPassword = (token, passwords) => async (dispatch) => {
    try {
        ...
        toast.error("password not matching please enter same value both fields")          
