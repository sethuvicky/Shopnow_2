...
import { updateProduct, getProducts, clearErrors,getPRoductdetails } from '../../actions/productActions'
...
const UpdateProduct = ({ match, history }) => {
   ...
   const {id} = useParams()
    ...
    const { error, product } = useSelector(state => state.productsdetails)
...
useEffect(()=>{
    ...
    const submitHandler = (e) => {
        ...
        dispatch(updateProduct(cookies.token,id, formData))
    }
